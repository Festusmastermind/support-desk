...
function Register() {
    //instead of different useState foreach field..
    ...
    const onSubmit = (e) => {
        ...
        if (password !== password2) {
            ...
            dispatch(register(userData))  //dispatch an action and send the data to register()
        }
    }
        ...
        <>
            ...
            <section className='form'>
                <form onSubmit={onSubmit}>
                    ...
                    <div className='form-group'>
                        <input type='password' className='form-control' id='password2' name='password2' value={password2} onChange={onChange} 
